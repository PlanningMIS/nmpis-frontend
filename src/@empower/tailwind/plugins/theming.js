...
// -----------------------------------------------------------------------------------------------------
// @ EMPOWER TailwindCSS Main Plugin
// -----------------------------------------------------------------------------------------------------
            ...
            const schemeCustomProps = _.map(
                ...
                (colorScheme) => {
                    ...
                    const background = theme(
                        `empower.customProps.background.${colorScheme}`
                    );
                    const foreground = theme(
                        `empower.customProps.foreground.${colorScheme}`
                    );
                        ...
                        _.flatten(
                            _.map(
                                ...
                                (name) => [
                                    [
                                        name,
                                        `rgba(var(--empower-${name}-rgb), <alpha-value>)`,
                                    ],
                                    [
                                        `on-${name}`,
                                        `rgba(var(--empower-on-${name}-rgb), <alpha-value>)`,
                                    ],
                                ]
                            )
                        )

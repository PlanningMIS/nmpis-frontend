...
export class EmpowerNavigationService {
    private _componentRegistry: Map<string, any> = new Map<string, any>();
    private _navigationStore: Map<string, EmpowerNavigationItem[]> = new Map<
        string,
        any
    >();
     ...
     * @param navigation
     */
    storeNavigation(key: string, navigation: EmpowerNavigationItem[]): void {
        // Add to the store
     ...
     * @param key
     */
    getNavigation(key: string): EmpowerNavigationItem[] {
     ...
     */
    getFlatNavigation(
        navigation: EmpowerNavigationItem[],
        flatNavigation: EmpowerNavigationItem[] = []
    ...
    getItemParent(
        id: string,
        navigation: EmpowerNavigationItem[],
        parent: EmpowerNavigationItem[] | EmpowerNavigationItem
    ): EmpowerNavigationItem[] | EmpowerNavigationItem | null {
        for (const item of navigation) {
            if (item.id === id) {
                return parent;
            }

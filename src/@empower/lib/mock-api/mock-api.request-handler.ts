...
import { EmpowerMockApiReplyCallback } from '@empower/lib/mock-api/mock-api.types';
import { Observable, of, take, throwError } from 'rxjs';

export class EmpowerMockApiHandler {
    request!: HttpRequest<any>;
    urlParams!: { [key: string]: string };

    // Private
    private _reply: EmpowerMockApiReplyCallback = undefined;
     ...
     * @param callback
     */
    reply(callback: EmpowerMockApiReplyCallback): void {
        // Store the reply

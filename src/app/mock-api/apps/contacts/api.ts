...
import { EmpowerMockApiService, EmpowerMockApiUtils } from '@empower/lib/mock-api';
import {
...
export class ContactsMockApi {
    ...
    registerHandlers(): void {
        ...
        // @ Contacts - GET
        // -----------------------------------------------------------------------------------------------------
        this._empowerMockApiService.onGet('api/apps/contacts/all').reply(() => {
            // Clone the contacts
        ...
        this._empowerMockApiService
            ...
            .reply(({ request }) => {
                ...
                // Generate a new GUID
                newTag.id = EmpowerMockApiUtils.guid();

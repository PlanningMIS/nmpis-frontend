...
export class HistopathologyComponent implements OnInit, AfterViewInit, OnDestroy{
  ...
  finance: any = {
     ...
     */
        navigateToNurseService(): void {
            this.router.navigate(['apps/consultation/nurse-service']);
        }

...
import { BillingCategoryDialog } from '../dialogs/billing-category/billing-category.component';
import { MatDialog } from '@angular/material/dialog';


@Component({
  selector: 'app-billing-category',
 encapsulation: ViewEncapsulation.None,
  ...
  templateUrl: './billing-category.component.html',
  styleUrl: './billing-category.component.scss'
})

export class BillingCategoryComponent implements OnInit, AfterViewInit, OnDestroy{
     ...
     */
        openConfirmationDialog(): void {
            ...
            dialogRef.afterClosed().subscribe((result) => {
                 ...
                 * Open confirmation dialog
                 */
                openBillingCategoryDialog(): void {
                    // Open the dialog
                    this.dialog.open(BillingCategoryDialog, {
                        autoFocus: false,

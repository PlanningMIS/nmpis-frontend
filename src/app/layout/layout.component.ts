...
import { EmpowerConfig, EmpowerConfigService } from '@empower/services/config';
...
import { EMPOWER_VERSION } from '@empower/version';
...
export class LayoutComponent implements OnInit, OnDestroy {
    ...
    constructor(
        ...
        private _empowerConfigService: EmpowerConfigService,
        private _empowerMediaWatcherService: EmpowerMediaWatcherService,
        private _empowerPlatformService: EmpowerPlatformService
    ) {}
    ...
    ngOnInit(): void {
        ...
        combineLatest([
            this._empowerConfigService.config$,
            this._empowerMediaWatcherService.onMediaQueryChange$([
        ...
        this._empowerConfigService.config$
            ...
            .subscribe((config: EmpowerConfig) => {
                // Store the config
                this.config = config;
        ...
        this._renderer2.addClass(
            this._document.body,
            this._empowerPlatformService.osName
        );
    }
